    ...
    <div style="display: flex">
      ...
      <div style="width: 80%;background-color: white;margin-bottom: 50px">
        ...
        <div style="display: flex;margin: 0 25px;height: 550px">
          ...
          <div style="flex: 4;margin-top: 15px">
            <div>
            ...
            <div style=" display: flex;margin-top: 50px">
              <div style="flex: 1;text-align: center">
                <a href="#" @click="navTo('/front/collect')">
                  <img src="@/assets/imgs/收藏.png" alt="" style="width: 25px;height: 25px">
                  <div>我的收藏</div>
                </a>
              </div>
              <div style="flex: 1;text-align: center">
                <a href="#" @click="navTo('/front/address')">
                <img src="@/assets/imgs/店铺.png" alt="" style="width: 25px;height: 25px">
                <div>我的地址</div>
                </a>
              </div>
              <div style="flex: 1;text-align: center">
                <a href="#" @click="navTo('/front/cart')">
                <img src="@/assets/imgs/购物车.png" alt="" style="width: 25px;height: 25px">
                <div>我的购物车</div>
                </a>
              </div>
              <div style="flex: 1;text-align: center">
                <a href="#" @click="navTo('/front/orders')">
                <img src="@/assets/imgs/订单.png" alt="" style="width: 25px;height: 25px">
                <div>我的订单</div>
                </a>
              </div>
            </div>
        ...
        <div style="margin: 40px 0 0 15px;height: 40px;background-color: #04BF04FF;font-size: 20px;color: white;width: 130px;font-weight:bold;line-height: 40px;  border-radius: 20px;text-align: center">热卖商品</div>
        <div style="margin: 10px 5px 0 5px">
          <el-row>
            <el-col :span="5" v-for="item in goodsData">
              ...
              <div style="margin-top: 10px;font-weight:500;font-size: 16px;width: 180px;color: black; text-overflow: ellipsis;overflow: hidden;white-space: nowrap;padding-right: 20px">{{item.name}}}</div>
              <div style="margin-top: 5px;font-size: 20px;color: #FF5000FF">¥ {{item.price}} / {{ item.unit }}</div>
            </el-col>
          </el-row>
        </div>
        <div style="margin: 40px 0 0 15px;height: 40px;background-color: #04BF04FF;font-size: 20px;color: white;width: 130px;font-weight:bold;line-height: 40px;  border-radius: 20px;text-align: center">猜你喜欢</div>
        <div style="margin: 10px 5px 0 5px">
          <el-row>
