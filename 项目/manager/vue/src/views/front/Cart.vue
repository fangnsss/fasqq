        ...
        <div style="margin: 20px 0;padding: 0 50px;">
          <div class="table">
            <el-table :data="goodsData" strip @selection-change="handleSelectionChange">
              ...
              <el-table-column prop="businessName" label="店铺名称" width="100">
                <template v-slot="scope">
                  <a :href="'/front/business?id='+scope.row.businessId">{{scope.row.businessName}}</a>
                </template>
              </el-table-column>
              <el-table-column prop="goodsPrice" label="商品价格" width="90"></el-table-column>
...
import Collect from "@/views/front/Collect.vue";
