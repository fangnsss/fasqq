<template>
  <div class="main-content">
    <div style=" width: 60%; margin: 30px auto; border-radius: 20px">
      <div style="height: 100px; padding: 0 10px;display: flex;align-items: center;border-radius: 20px;background-color: white">
        <img :src="businessData.avatar" alt="" style="height: 60px;width: 60px;border-radius: 50%">
        <div style="width: 100px;margin: 0 30px 0 15px;font-size: 15px;font-weight: bold">
        ...
        <div style="height: 100px;flex: 1;padding: 20px">
          <div style="font-size: 16px;height: 60px;line-height: 30px;color: black;overflow: hidden; text-overflow: ellipsis; display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical;">
            店铺介绍:{{ businessData.description }}
          </div>
        </div>
      </div>
      <div style="border-radius: 20px;padding: 0 20px;background-color: white;margin-top: 20px">
      <div style="font-size: 18px;color: black;line-height: 80px;border-bottom: #cccccc 1px solid">本店所有商品({{goodsData.length}}件)</div>
      <div style="margin-top: 20px">
        <el-row>
          <el-col :span="5" style="margin-bottom: 20px" v-for="item in goodsData">
            ...
            <div style="margin-top: 10px; font-weight: 500; font-size: 16px; width: 130px; color: #000000FF; text-overflow: ellipsis; overflow: hidden; white-space: nowrap;">{{item.name}}</div>
