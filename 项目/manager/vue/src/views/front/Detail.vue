    ...
    <div style="width: 60%;background-color: white;min-height: 1000px;margin: 20px auto;border-radius: 20px">
      <div style="padding: 15px 20px">
        <el-row :gutter="20">
          ...
          <el-col :span="12">
            <div style="font-size: 20px;font-weight: 900;text-overflow: ellipsis;overflow: hidden;display: -webkit-box;-webkit-line-clamp: 2;-webkit-box-orient: vertical">{{goodsData.name}}}</div>
            <div style="font-size: 14px;color: #666666FF;margin-top: 5px">销量: {{goodsData.count}}</div>
            <div style="color: red;margin-top: 15px">疯抢价: ￥<span style="font-size: 20px">{{goodsData.price}} / {{goodsData.unit}}</span></div>
            <div style="margin-top: 20px">
              <img src="@/assets/imgs/right.png" alt="" style="width: 70%;height: 113px;border-radius: 15px">
            </div>
            <div style="font-size: 14px;color: #666666FF;margin-top: 20px">商家:<a href="#" @click="navTo('/front/business?id='+goodsData.businessId)">{{goodsData.businessName}}</a></div>
            <div style="font-size: 14px;color: #666666FF;margin-top: 20px">分类:<a href="#" @click="navTo('/front/type?id='+goodsData.typeId)">{{goodsData.typeName}}</a></div>
            <div style="margin-top: 20px">
              <el-button type="warning" @click="addCart">加入购物车</el-button>
              <el-button type="warning" @click="collect">加入收藏</el-button>
            </div>
          </el-col>
        </el-row>
      </div>
              ...
              <div style="margin-top: 20px" v-for="item in commentData">
                <div style="display: flex">
                  ...
                  <div style="width: 200px;margin-left: 10px">
                    <div style="font-weight: 700;color: black;font-size: 17px">{{item.userName}}</div>
